...
### 6.2. Операция скобки (операция изменеия приоритетов).
...
|16|,|слева направо|перечисление аргументов функции|
