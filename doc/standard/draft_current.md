...
Алгоритм - это набор команд, выполняемых методом. Команды могут быть простыми или блочными.
...
??? Расписать правила описания синтаксиса у алгоритмов.
...
Вычисление выражения может быть использовано для вызова функции, или, используя необязательность полного вычисления логических функций, можно вызывать не все функции подряд.
...
Тип переменной определяется по типу выражения справа от знака равенства. Тип переменной определяется при инициализации и далее не меняется.
...
Команда присваивает значение выражения переменной. Переменная должна быть объявлена заранее. Тип выражения справа должен совпадать с типом переменной.
