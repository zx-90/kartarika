...
Идентификатором называется последовательность букв, цифр и символа подчёркивания. Идентификатор не может начинаться с цифры. Кроме того, буквы в одном и том же идентификаторе должны быть из одного и того же алфавита Unicode. Описание алфавитов Unicode можно найти по данной ссылке: [https://www.unicode.org/charts/](https://www.unicode.org/charts/)
...
Буква = А-Я | а-я | A-Z | a-z | СимволПодчёркивания
