...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[8.1.1. Класс Кар.Типы.Целое8.](#8.1.1)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[8.1.2. Класс Кар.Типы.Целое16.](#8.1.2)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[8.1.3. Класс Кар.Типы.Целое32.](#8.1.3)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[8.1.4. Класс Кар.Типы.Целое64.](#8.1.4)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[8.1.5. Класс Кар.Типы.Целое.](#8.1.5)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[8.1.6. Класс Кар.Типы.Счётное8.](#8.1.6)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[8.1.7. Класс Кар.Типы.Счётное16.](#8.1.7)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[8.1.8. Класс Кар.Типы.Счётное32.](#8.1.8)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[8.1.9. Класс Кар.Типы.Счётное64.](#8.1.9)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[8.1.10. Класс Кар.Типы.Счётное.](#8.1.10)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[8.1.11. Класс Кар.Типы.Дробное32.](#8.1.11)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[8.1.12. Класс Кар.Типы.Дробное64.](#8.1.12)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[8.1.13. Класс Кар.Типы.Дробное.](#8.1.13)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[8.1.14. Класс Кар.Типы.Буль.](#8.1.14)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[8.2.1. Класс Кар.Потоки.ПотокВвода.](#8.2.1)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[8.2.2. Класс Кар.Потоки.ПотокВывода.](#8.2.2)
...
стат метод Запустить() Целое:
	Консоль.Вывод.Писать("Привет, мир!\н")
	вернуть 0
~~~~
...
стат метод Запустить() Целое:
    ...
    пока Радиус мш 10.0:
        Радиус = Радиус + 1.0
        Консоль.Вывод.Писать("Если радиус = ")
        Консоль.Вывод.Писать(Радиус)
        Консоль.Вывод.Писать(", то длина окружности = ")
        Консоль.Вывод.Писать(2 * Пи * Радиус)
...
Консоль.Вывод.Писать(Количество.или(-1))

раскрыть Количество как Кол:
    Консоль.Вывод.Писать(Кол)
иначе:
    Консоль.Вывод.Писать("Количество не определено")
~~~~
...
~~~~
Консоль.Вывод.Писать("Привет, мир!!!".Длина())
~~~~
...
~~~~
Кар.Консоль.Вывод.Писать(Кар.Типы.Целое8.Мин) // Полное описание.
Консоль.Вывод.Писать(Целое8.Мин) // Краткое описание.
~~~~
...
<a name=8.1.7></a>
#### 8.1.7. Класс Кар.Типы.Счётное16.
...
<a name=8.1.8></a>
#### 8.1.8. Класс Кар.Типы.Счётное32.
...
<a name=8.1.9></a>
#### 8.1.9. Класс Кар.Типы.Счётное64.
...
<a name=8.1.11></a>
#### 8.1.11. Класс Кар.Типы.Дробное32.
...
<a name=8.1.12></a>
#### 8.1.12. Класс Кар.Типы.Дробное64.
...
<a name=8.2.1></a>
#### 8.2.1. Класс Кар.Потоки.ПотокВвода.
...
~~~~
стат поле Ввод = Кар.Потоки.ПотокВвода()
~~~~

Стандартный поток ввода программы.

~~~~
стат поле Вывод = Кар.Потоки.ПотокВывода()
~~~~

Стандартный поток вывода программы.

~~~~
стат поле Ошибка = Кар.Потоки.ПотокВывода()
~~~~
