...
~~~~
Выражение = ОткрывающаясяСкобка {ПробельныйСимвол} Выражение {ПробельныйСимвол} ЗакрывающаясяСкобка
~~~~
...
~~~~
ОбращениеКМетоду = Идентификатор ОткрывающаясяСкобка [ {ПробельныйСимвол} Выражение {ПробельныйСимвол} {Запятая {ПробельныйСимвол} Выражение {ПробельныйСимвол} } ] ЗакрывающаясяСкобка
~~~~
