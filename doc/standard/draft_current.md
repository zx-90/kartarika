...
КлючевоеСлово =
    ...
    ОпБитыВлево | АлгоритмБлок | АлгоритмРаскрыть | АлгоритмЕсли |
    АлгоритмИначе | АлгоритмПовторить | АлгоритмПока |
    АлгоритмСледующий | АлгоритмПрервать | ОбъявлениеПоля |
...
Множество токенов-операторов частично пересекается с множеством ключевых слов. Подробное описание значений этих токенов описаны в главе выражения (??? ссылка).
