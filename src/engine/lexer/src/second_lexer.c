...
static bool retype_all(KarToken* token, KarModule* module) {
	...
	retype_if_check(token, KAR_TOKEN_IDENTIFIER, KAR_KEYWORD_COMMAND_CLEAN_AS, KAR_TOKEN_COMMAND_CLEAN_AS);
	...
	retype_if_check(token, KAR_TOKEN_IDENTIFIER, KAR_KEYWORD_COMMAND_REPEAT, KAR_TOKEN_COMMAND_REPEAT);
