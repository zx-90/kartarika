...
#define PROCESS_VAL(p) case(KAR_TOKEN_##p): return #p;
	switch(type){
		...
		//PROCESS_VAL(METHOD_PRIVATE);
		//PROCESS_VAL(METHOD_PROTECTED);
		//PROCESS_VAL(METHOD_PUBLIC);
		//PROCESS_VAL(METHOD_LOCAL);
		PROCESS_VAL(MODIFIER_STAT);
		
		PROCESS_VAL(METHOD_PARAMETERS);
		//PROCESS_VAL(METHOD_ARGUMENT_CONST);
		//PROCESS_VAL(METHOD_ARGUMENT_VAR);
		//PROCESS_VAL(METHOD_ARGUMENT_POINTER);
		
		PROCESS_VAL(METHOD_RETURN_TYPE);
		PROCESS_VAL(METHOD_RETURN);
