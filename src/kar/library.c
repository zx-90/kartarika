...
#define _KARTARIKA_CONVERT_INT_TO_UNSIGNED(num_from, num_to)\
uint##num_to##_t _kartarika_library_convert_integer##num_from##_to_unsigned##num_to(int##num_from##_t value) { \
	return value; \
}

_KARTARIKA_CONVERT_INT_TO_UNSIGNED(8, 8)
_KARTARIKA_CONVERT_INT_TO_UNSIGNED(8, 16)
_KARTARIKA_CONVERT_INT_TO_UNSIGNED(8, 32)
_KARTARIKA_CONVERT_INT_TO_UNSIGNED(8, 64)
_KARTARIKA_CONVERT_INT_TO_UNSIGNED(16, 8)
_KARTARIKA_CONVERT_INT_TO_UNSIGNED(16, 16)
_KARTARIKA_CONVERT_INT_TO_UNSIGNED(16, 32)
_KARTARIKA_CONVERT_INT_TO_UNSIGNED(16, 64)
_KARTARIKA_CONVERT_INT_TO_UNSIGNED(32, 8)
_KARTARIKA_CONVERT_INT_TO_UNSIGNED(32, 16)
_KARTARIKA_CONVERT_INT_TO_UNSIGNED(32, 32)
_KARTARIKA_CONVERT_INT_TO_UNSIGNED(32, 64)
_KARTARIKA_CONVERT_INT_TO_UNSIGNED(64, 8)
_KARTARIKA_CONVERT_INT_TO_UNSIGNED(64, 16)
_KARTARIKA_CONVERT_INT_TO_UNSIGNED(64, 32)
_KARTARIKA_CONVERT_INT_TO_UNSIGNED(64, 64)
